...
NameBot = (DevRio:get(Trend..'Rio:NameBot') or 'ديفل')
--     Source Trend     --
...
if text and text:match('^'..(DevRio:get(Trend..'Rio:NameBot') or "ديفل")..' ') then
data.message_.content_.text_ = data.message_.content_.text_:gsub('^'..(DevRio:get(Trend..'Rio:NameBot') or "ديفل")..' ','')
end
...
local BotName = (DevRio:get(Trend.."Rio:NameBot") or 'ديفل')
...
if text and text == (DevRio:get(Trend..'Rio:NameBot') or 'ديفل') then 
NameBot = (DevRio:get(Trend..'Rio:NameBot') or 'ديفل')
...
DevRio:set(Trend..'Rio:NameBot',(DevRio:get(Trend..'Name:Bot') or 'ديفل'))
end
for i = 1, #Users do
local id = Users[i]
if id:match("^(%d+)") then
